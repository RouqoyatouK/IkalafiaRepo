...
<div class="contact-form-error alert alert-danger d-none mt-4">
  ...
  <input type="text" name="fraction_de" value="{{$demande->fraction_de}}"><br>
  <div class="invalid-feedback" data-sb-feedback="name:required">Name is required.</div>
  </div>
  <div class="mb-3">
  <label for="numero_delivrance">Numero_delivrance </label>
  <input type="text" name="numero_delivrance" value="{{$demande->numero_delivrance}}"><br>
  <div class="invalid-feedback" data-sb-feedback="name:required">Name is required.</div>
  </div>
  <div class="mb-3">
  ...
  <input type="date" name="date_demande" value="{{$demande->date_demande}}"><br>
  <div class="invalid-feedback" data-sb-feedback="name:required">Name is required.</div>
  </div>
  <div class="mb-3">
  ...
  <input type="text" name="lieu_conception" value="{{$demande->lieu_conception}}"><br>
  <div class="invalid-feedback" data-sb-feedback="name:required">Name is required.</div>
  </div>
  <div class="mb-3">
  ...
  <input type="file" name="piece_tuteur" id="image" accept=".jpg, .jpeg, .png"  value="{{$demande->piece_tuteur}}"><br>
  <div class="invalid-feedback" data-sb-feedback="name:required">Name is required.</div>
  </div>
