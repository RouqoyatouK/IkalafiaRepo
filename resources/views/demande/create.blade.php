    ...
    <div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Bienvenue</h3>
                        <p>Faite votre renouvellement de carte 
                         Renseigner les champs SVP!</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="nom"></label>
                                            ...
                                            @if($errors->first('nom'))
<div class="alert-danger">oups!Ce champ est obligatoire ou est deja utilisé</div>
@endif
                                        </div>
                                        <div class="form-group">
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="piece_tuteur" value="piece_tuteur" name="piece_tuteur" accept="image/png,image/jpg,image/jpeg" />
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder="date naissance *" name="date_demande" />
                                            @if($errors->first('date_demande'))
<div class="alert-danger">oups!Ce champ est obligatoire ou est deja utilisé</div>
@endif
                                        </div>
