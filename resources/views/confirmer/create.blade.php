...
<form id="contactForm"action="{{route('confirmer.store') }}" method="POST">
@csrf
<div class="contact-form-error alert alert-danger d-none mt-4">
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control" id="message" type="text" placeholder="Message" style="height: 4rem;" data-sb-validations="required" name="message" ></textarea>
