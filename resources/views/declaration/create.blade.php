...
<input type="text" class="form-control" id="first-name" name="profession">
...
<input type="text" class="form-control" id="first-name" name="quartier">
...
<input type="text" name="email" class="form-control" id="comment">
</div>
</div>
