...
<head>
    ...
    <title>Renouvellement-ikalafia</title>
    ...
    <div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Bienvenue</h3>
                        <p>Faite votre renouvellement de carte !</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="nom"></label>
                                            ...
                                            @if($errors->first('nom'))
<div class="alert-danger">oups!Ce champ est obligatoire ou deja utilisé</div>
@endif
                                        </div>
                                        <div class="form-group">
...
@endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="photo_identite " value="photo_identite" name="photo_identite" accept="image/png,image/jpg,image/jpeg" />
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="photo_profession" value="photo_profession" name="photo_profession" accept="image/png,image/jpg,image/jpeg"  />
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="photo_ancienne_carte" value="photo_ancienne_carte" name="photo_ancienne_carte" accept="image/png,image/jpg,image/jpeg" />
                                            @if($errors->first('photo_ancienne_carte'))
<div class="alert-danger">oups!Ce champ est obligatoire ou deja utilisé</div>
@endif
                                        </div>
                                        <div class="form-group">
                                            <label for="acte_naissance">photo-acte-naissce</label>
                                            <input type="file" class="form-control" placeholder="acte_naissance*" value="acte_naissance" name="acte_naissance" accept=".png, .jpg, .jpeg" />
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder="date-renouvellement *" name="date_renouvellement" min="1900-01-31" max="2004-01-31" />
                                            @if($errors->first('date_renouvellement'))
<div class="alert-danger">oups!Ce champ est obligatoire ou deja utilisé</div>
@endif
                                        </div>
