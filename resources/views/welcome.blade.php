...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="imgAcceuil/favicon.ico" type="image/x-icon" />
	<link rel="apple-touch-icon" href="imgAcceuil/apple-touch-icon.png">
	...
	<link rel="stylesheet" href="vendorAcceuil/fontawesome-free/css/all.min.css">
	<link rel="stylesheet" href="vendorAcceuil/animate/animate.compat.css">
	<link rel="stylesheet" href="vendorAcceuil/simple-line-icons/css/simple-line-icons.min.css">
	<link rel="stylesheet" href="vendorAcceuil/owl.carousel/assets/owl.carousel.min.css">
	<link rel="stylesheet" href="vendorAcceuil/owl.carousel/assets/owl.theme.default.min.css">
	<link rel="stylesheet" href="vendorAcceuil/magnific-popup/magnific-popup.min.css">

	<!-- Theme CSS -->
	<link rel="stylesheet" href="cssAcceuil/theme.css">
	<link rel="stylesheet" href="cssAcceuil/theme-elements.css">
	<link rel="stylesheet" href="cssAcceuil/theme-blog.css">
	<link rel="stylesheet" href="cssAcceuil/theme-shop.css">

	<!-- Demo CSS -->
	<link rel="stylesheet" href="cssAcceuil/demos/demo-startup-agency.css">

	<!-- Skin CSS -->
	<link id="skinCSS" rel="stylesheet" href="cssAcceuil/skins/skin-startup-agency.css">

	<!-- Theme Custom CSS -->
	<link rel="stylesheet" href="cssAcceuil/custom.css">

	<!-- Head Libs -->
	<script src="vendorAcceuil/modernizr/modernizr.min.js"></script>
...
<body data-plugin-scroll-spy data-plugin-options="{'target': '#header'}">
									...
									<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
										<nav class="collapse">
											<ul class="nav nav-pills" id="mainNav">
												...
												<li><a href="{{ route('contact.index') }}" class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="70">aide</a></li>
		...
		<div role="main" class="main">
			...
			<section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
				...
				<div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
					...
					<!--div class="respons">
						<img src="imgAcceuil\demos\startup-agency\icons\respons.svg" alt="">
                        </div-->
					...
					<div class="pricing-table pricing-table-no-gap custom-pricing-table-style-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
						<div class="col-md-6 col-lg-3">
							<div class="plan">
								...
								<div class="plan-footer">
									<a href="#" class="btn btn-dark text-3 font-weight-bold border-0 btn-px-5 py-3">Get
										Started</a>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 col-lg-3">
							<div class="plan plan-featured">
								...
								<div class="plan-footer">
									<a href="#" class="btn btn-gradient text-3 font-weight-bold btn-px-5 py-3">Get
										Started</a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6 ps-lg-5">
							...
							<div class="row">
								<div class="col">
									...
									<form class="contact-form custom-form-style-1 form-errors-light" action="{{route('contact.store') }}" method="POST">
									@csrf
										...
										<div class="row">
											<div class="form-group col">
												<input type="text" value="" data-msg-required="Please enter your name." maxlength="100" class="form-control" name="nom" placeholder="Votre nom" required>
											</div>
										</div>
										<div class="row">
											<div class="form-group col">
										...
										<div class="row">
											<div class="form-group col">
												<textarea maxlength="5000" data-msg-required="Please enter your message."  input type="text"  rows="6" class="form-control" name="message" placeholder="Votre Message" required></textarea>
											</div>
										</div>
										<div class="row">
											<div class="form-group col text-center">
												<input type="submit" value="Envoyer " class="btn btn-gradient text-3 font-weight-bold px-5 py-3" data-loading-text="Envoie en cours...">
											</div>
										</div>
									</form>
	...
	<!-- Vendor -->
	<script src="vendorAcceuil/jquery/jquery.min.js"></script>
	<script src="vendorAcceuil/jquery.appear/jquery.appear.min.js"></script>
	<script src="vendorAcceuil/jquery.easing/jquery.easing.min.js"></script>
	<script src="vendorAcceuil/jquery.cookie/jquery.cookie.min.js"></script>
	<script src="vendorAcceuil/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script src="vendorAcceuil/jquery.validation/jquery.validate.min.js"></script>
	<script src="vendorAcceuil/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
	<script src="vendorAcceuil/jquery.gmap/jquery.gmap.min.js"></script>
	<script src="vendorAcceuil/lazysizes/lazysizes.min.js"></script>
	<script src="vendorAcceuil/isotope/jquery.isotope.min.js"></script>
	<script src="vendorAcceuil/owl.carousel/owl.carousel.min.js"></script>
	<script src="vendorAcceuil/magnific-popup/jquery.magnific-popup.min.js"></script>
	<script src="vendorAcceuil/vide/jquery.vide.min.js"></script>
	<script src="vendorAcceuil/vivus/vivus.min.js"></script>
	<script src="vendorAcceuil/kute/kute.min.js"></script>

	<!-- Theme Base, Components and Settings -->
	<script src="jsAcceuil/theme.js"></script>

	<!-- Current Page Vendor and Views -->
	<script src="jsAcceuil/views/view.contact.js"></script>

	<!-- Demo -->
	<script src="jsAcceuil/demos/demo-startup-agency.js"></script>
